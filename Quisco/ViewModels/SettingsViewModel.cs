...
namespace Quisco.ViewModels
{
    ...
    public class SettingsViewModel : Observable
    {
        ...
        public async Task InitializeAsync()
        {
            ...
            User = await UserDataService.GetUserAsync().ConfigureAwait(true);
        }
        ...
        private async void OnLogIn()
        {
            ...
            {
                await AuthenticationHelper.ShowLoginErrorAsync(loginResult).ConfigureAwait(true);
                IsBusy = false;
            }
        }
        ...
        {
            IsBusy = true;
            await IdentityService.LogoutAsync().ConfigureAwait(true);
        }
